...
//    }
    ...
    public static void prototypeMaze() throws CloneNotSupportedException {
        MazePrototypeFactory simpleMazeFactory = new MazePrototypeFactory(new Maze(), new Wall(), new Room(100), new Door(new Room(30), new Room(40)));
        Maze myMaze = new MazeGame().createMaze(simpleMazeFactory);
